...
const get2DimWindow = _.flow([assignPanel]);
...
const joinTetrisTable = (state) => (getWindow({ bgPanel: state.bgPanel, toolPanel: state.toolPanel }));
const tetrisTable = (state) => (get2DimWindow({ bgPanel: state.bgPanel, toolPanel: state.toolPanel }));
